...
<a id="cpage" class="navbar-left" href="javascript:void(0)"><?= $mpage; ?></a>
 ...
 <div class="navbar-right">
  <?php if ($id == "sellers") { ?>
  <a href="<?= $adminDashboardUrl; ?>"><i class="fa fa-dashboard mr-1"></i> <?= $_dashboard ?></a>
  <?php } ?>
  ...
  <a title="Idle Timeout" style="<?= $didleto; ?>"><span class="idle-timer-wrap pd-5 radius-3"><i class="fa fa-clock-o mr-1"></i>  <span class="mr-1" id="timer"></span></span></a>
</div>
</div>
...
?>  
  <div class="menu text-center align-middle card-header nav-session-header"><h3 id="MikhmonSession"><?= $session; ?></h3></div>
...
<?php 
  ...
  <?php if ($id == "sellers" && !empty($session)) { ?>
  <div class="menu text-center align-middle card-header nav-session-header"><h3><?= $session; ?></h3></div>
  <a href="<?= $adminDashboardUrl; ?>" class="menu"><i class='fa fa-dashboard'></i> <?= $_dashboard ?></a>
  <?php } ?>
...
<div id="sidenav" class="sidenav">
  <div class="menu text-center align-middle card-header nav-session-header"><h3><?= $identity; ?></h3></div>
