...
// share WhatsApp
  ...
  if($getsprice == "" && $getprice != ""){
    $waprice = $_price." : *" . mikhmon_format_money_amount(mikhmon_parse_money_amount($getprice), $currency, $cekindo) . "* %0A";
    $btprice = $getprice;
  }else if($getsprice != ""){
    $waprice = $_price." : *" . mikhmon_format_money_amount(mikhmon_parse_money_amount($getsprice), $currency, $cekindo) . "* %0A";
    $btprice = $getsprice;
  }else if ($getsprice == "") {
    $waprice = "";
    $btprice = "";
...
if (mikhmon_currency_uses_integer_amounts($currency, $cekindo)) {
  $pricebt = mikhmon_format_money_amount(mikhmon_parse_money_amount($btprice), $currency, $cekindo);
...
<div class="group-item group-item-r pd-2p5 text-center">
  ...
  <tr>
    <td class="align-middle"><?= $_price ?></td><td><input class="form-control" id="price" type="text" value="<?php if ($getprice == 0) {
        ...
        echo mikhmon_format_money_amount(mikhmon_parse_money_amount($getprice), $currency, $cekindo);
      } ?>" disabled></td>
  </tr>
  <tr>
    <td class="align-middle"><?= $_selling_price ?></td><td><input class="form-control" id="price" type="text" value="<?php if ($getprice == 0) {
      } else {
        echo mikhmon_format_money_amount(mikhmon_parse_money_amount($getsprice), $currency, $cekindo);
      } ?>" disabled></td>
  </tr>
  <?php if ($getvalid != "") { ?>
  <tr>
